...
class CacheKeyGenerator:
    ...
    # def pattern_for_all_links(self) -> str:
    #     """Паттерн для всех ключей ссылок"""
    #     return self._build_key('link', '*')
    
    # def pattern_for_all_redirects(self) -> str:
    #     """Паттерн для всех ключей редиректов"""
    #     return self._build_key('redirect', '*')