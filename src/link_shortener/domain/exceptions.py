...
class BusinessRuleError(DomainError):
    ...
    def __init__(self, message: str, rule_name: Optional[str], details: Optional[Dict[str, Any]] = None):
...
class ValidationError(DomainError):
    ...
    def __init__(self, message: str, code: Optional[str] = None, field: Optional[str] = None, value: Optional[str] = None):
...
class EntityNotFoundError(DomainError):
    ...
    def __init__(self, entity_name: str, entity_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
...
class LinkNotFoundError(EntityNotFoundError):
    ...
    def __init__(self, short_code: Optional[str] = None, url_hash: Optional[str] = None):
