...
class CacheManager(BaseService):
    ...
    def __init__(self, logger: Optional[ILogger] = None, cache_client: Optional[ICacheClient] = None):
    ...
    def invalidate_link(self, link: Link, strategies: Dict[str, CacheKeyStrategy]) -> bool:
