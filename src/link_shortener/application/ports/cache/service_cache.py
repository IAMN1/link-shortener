...
class ServiceCache(LinkCache, RedirectCache, StatsCache, CacheHealth):
    """
    The four cache roles one object plays in this service.

    Every implementation -- Redis, in-memory and null -- already inherits all
    four, and the container hands the same instance out for each. Naming the
