...
```bash
uv run pytest tests/                      # 2518 tests, 88% coverage floor
...
```bash
uv run python tests/live/smoke_test.py    # 119 checks
uv run python tests/live/browser_test.py  # 16 checks, needs --group browser
```
