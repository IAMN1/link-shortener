...
```bash
uv run pytest tests/                      # 2830 tests, 88% coverage floor
...
```bash
uv run python tests/live/smoke_test.py    # 124 checks
uv run python tests/live/browser_test.py  # 37 checks, needs --group browser
```
