...
class TestRateLimitingIsOnByDefault:
    ...
    def test_the_brute_force_limits_are_the_documented_ones(self, name, profile_cls):
        ...
        Measured: the shipped pair refuses the sixth attempt, the swapped
        one does not refuse the fortieth.
        ...
        README.md and docs/OPERATIONS_AND_MIGRATIONS.md publish these
        numbers, so changing one is changing both documents too.
