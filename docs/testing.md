...
**5206 tests**, 98.65% coverage against a floor of 88%, plus two live runs
...
### browser_test.py — 69 checks in a real browser
...
flowchart TD
    subgraph clean["clean"]
        ...
        C4 --> C5[smoke_test.py<br/>159 checks] --> C6[browser_test.py<br/>69 checks]
    end
