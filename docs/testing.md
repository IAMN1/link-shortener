...
**3896 tests**, 97.43% coverage against a floor of 88%, plus two live runs
...
### browser_test.py — 65 checks in a real browser
...
gives 92/157, the browser run 18/65.
...
flowchart TD
    subgraph clean["clean"]
        ...
        C2 --> C3[count collected tests<br/>minimum 3888] --> C4[pytest --error-for-skips]
        C4 --> C5[smoke_test.py<br/>157 checks] --> C6[browser_test.py<br/>65 checks]
    end
...
which tool objected: `flake8`, `pylint` (floor 9.0, currently 9.25),
