...
[![тестов: 3960](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-3960-0b5d3b)](docs/testing.md)
[![покрытие: 96%](https://img.shields.io/badge/%D0%BF%D0%BE%D0%BA%D1%80%D1%8B%D1%82%D0%B8%D0%B5-96%25-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 3960 тестов
uv run python tests/live/smoke_test.py    # 157 проверок по HTTP
uv run python tests/live/browser_test.py  # 65 проверок настоящим браузером
```
