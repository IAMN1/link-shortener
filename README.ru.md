...
[![тестов: 3669](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-3669-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 3669 тестов
uv run python tests/live/smoke_test.py    # 156 проверок по HTTP
uv run python tests/live/browser_test.py  # 64 проверки настоящим браузером
```
