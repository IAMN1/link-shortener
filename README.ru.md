...
[![тестов: 2664](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-2664-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 2664 тестов
uv run python tests/live/smoke_test.py    # 123 проверок по HTTP
uv run python tests/live/browser_test.py  # 18 проверок настоящим браузером
```
