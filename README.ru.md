...
[![тестов: 4608](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-4608-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 4608 тестов
...
| [Принятые решения](docs/decisions.md) | Девяносто пять разборов, почему сделано так, а не иначе |
