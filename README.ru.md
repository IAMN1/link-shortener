...
[![тестов: 5210](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-5210-0b5d3b)](docs/testing.md)
...
<img src="docs/media/demo.gif" alt="Длинный адрес сокращают, переключают тему на тёмную и открывают панель: ссылки, страница одной ссылки с её QR-квадратом, месяц статистики по устройствам и браузерам, журнал аудита, список учётных записей и редактор ролей" width="820">
...
```bash
uv run pytest tests/                      # 5210 тестов
...
| [Принятые решения](docs/decisions.md) | Сто один разбор, почему сделано так, а не иначе |
