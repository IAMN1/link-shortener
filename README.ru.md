...
[![тестов: 4208](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-4208-0b5d3b)](docs/testing.md)
...
Тридцать восемь операций. Полное описание — `/api/openapi.json`, страницей —
`/api/docs`.
...
```bash
uv run pytest tests/                      # 4208 тестов
...
| [Конфигурация](docs/configuration.md) | Профили, приоритет и настройки, которые кусаются; исчерпывающий список — `.env.example` |
...
| [Принятые решения](docs/decisions.md) | Девяносто один разбор, почему сделано так, а не иначе |
