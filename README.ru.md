...
[![тестов: 3066](https://img.shields.io/badge/%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-3066-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 3066 тестов
...
| [Принятые решения](docs/decisions.md) | Сорок один разбор, почему сделано так, а не иначе |
