...
[![tests: 3468](https://img.shields.io/badge/tests-3468-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 3468 tests
uv run python tests/live/smoke_test.py    # 156 checks over HTTP
uv run python tests/live/browser_test.py  # 62 checks in a real browser
```
