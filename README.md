...
[![tests: 4608](https://img.shields.io/badge/tests-4608-0b5d3b)](docs/testing.md)
...
```bash
uv run pytest tests/                      # 4608 tests
...
| [Decisions](docs/decisions.md) | Ninety-five write-ups of why something is the way it is |
