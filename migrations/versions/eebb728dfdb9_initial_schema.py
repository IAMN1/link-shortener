...
Revision ID: eebb728dfdb9
Revises: 
Create Date: 2026-05-03 10:39:58.759455
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_urls_url_hash'), 'urls', ['url_hash'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_urls_url_hash'), table_name='urls')
